...
public class ServiceInformationPrioritisedTest
{
	...
	{
		final ServiceInformation lowest = serviceInformation(Zero, Four, somePort, someHostName);
		final ServiceInformation middleAndSame1 = serviceInformation(Zero, Four, somePort, someHostName);
		final ServiceInformation middleAndSame2 = serviceInformation(Zero, Four, somePort, someHostName);
